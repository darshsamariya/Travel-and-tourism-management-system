...
import java.util.*;
	public class checkhotel extends JFrame implements Runnable{
		...
		public void run()
		{
			String m[]= new String[]{"JW Mariiott","Boleuvard 9 Resort n Spa","Hyaat Resort","Ramada","Ramee Royal","Via Lakhela Resort","Ananta Resort","Maharaja 5-star","Sterling Holidays","Escobar Hotels"};
		...
		checkhotel()
		{
			...
			for(int i=1;i<=10;i++)
			{
				ImageIcon i1=new ImageIcon(ClassLoader.getSystemResource("travel/management/system/icons/hotel"+i+".jpg"));
